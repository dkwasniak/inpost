...
class ShipmentStatusDtoTest {
    ...
    fun `should maintain the correct order of statuses`() {
        ...
        val expectedOrder = listOf(
            ShipmentStatusDto.NOT_READY,                 // Priority 1
            ShipmentStatusDto.CREATED,                 // Priority 2
            ShipmentStatusDto.CONFIRMED,               // Priority 3
            ShipmentStatusDto.ADOPTED_AT_SOURCE_BRANCH, // Priority 4
            ShipmentStatusDto.SENT_FROM_SOURCE_BRANCH,  // Priority 5
            ShipmentStatusDto.ADOPTED_AT_SORTING_CENTER, // Priority 6
            ShipmentStatusDto.SENT_FROM_SORTING_CENTER,  // Priority 7
            ShipmentStatusDto.OTHER,                   // Priority 8
            ShipmentStatusDto.DELIVERED,               // Priority 9
            ShipmentStatusDto.RETURNED_TO_SENDER,      // Priority 10
            ShipmentStatusDto.AVIZO,                   // Priority 11
            ShipmentStatusDto.OUT_FOR_DELIVERY,        // Priority 12
            ShipmentStatusDto.READY_TO_PICKUP,         // Priority 13
            ShipmentStatusDto.PICKUP_TIME_EXPIRED      // Priority 14
        )
